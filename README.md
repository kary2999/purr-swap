...
基于 **Flutter 3.19+** 跨平台构建，已发布 Android / macOS / Web 三端。当前版本 **v0.2.5**。
...
| 平台 | 文件 | 要求 |
|---|---|---|
| 📱 Android | `PurrSwap-v0.2.5-Android.apk` | Android 7.0+ |
| 🖥 macOS | `PurrSwap-v0.2.5-macOS.dmg` | macOS 10.14+（M1–M4 / Intel 通用） |
| 🌐 Web/源码 | `PurrSwap-v0.2.5-release.zip` | 任意浏览器，解压后启 web server |
